...
|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------|------------------------|
| `/mcctoggle [door]` | This is the base command that. (See [`config.doorControl`](https://docs.sonoran.store/en/mcc/getting-started#configdoorcontrol-breakdown) for all the possible doors)
