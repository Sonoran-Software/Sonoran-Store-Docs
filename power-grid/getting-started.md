...
![kaicwrm.png](/power-system/kaicwrm.png)
2. In the `sonoran-powergrid` folder are three files you must change and configure: `config.CHANGEME.lua` needs to be renamed to `config.lua`, `discord.CHANGEME.lua` renamed to `discord.lua`, and finally `systems.CHANGEME.json` renamed to `systems.json`.
![w2oim4j.png](/power-system/w2oim4j.png)
